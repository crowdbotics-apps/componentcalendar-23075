"""componentcalendar_23075 URL Configuration
...
admin.site.site_header = "ComponentCalendar"
admin.site.site_title = "ComponentCalendar Admin Portal"
admin.site.index_title = "ComponentCalendar Admin"

# swagger
api_info = openapi.Info(
    title="ComponentCalendar API",
    default_version="v1",
    description="API documentation for ComponentCalendar App",
)
